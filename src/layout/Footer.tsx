    ...
    <footer className="flex flex-col w-full border-t z-10 bg-[#171717] text-white py-10 gap-8">
      <section className="flex flex-row justify-around max-sm:flex-col max-sm:items-center">
        <div>
          ...
          <p className="text-gray-400">Une recherche, un clic, une histoire, une claque !</p>
        </div>
      ...
      <section className="flex flex-col items-center gap-2">
        ...
        <p className="text-gray-500">© {new Date().getFullYear()} Click&Paf. Tous droits réservés.</p>
      </section>
    </footer>
  );
}
