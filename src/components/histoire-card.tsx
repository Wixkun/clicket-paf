...
const HistoireCard = ({ histoireWithImage, showContent = false, props = '', imageProps = 'h-32 object-cover' }: HistoireCardProps) => {
  return (
    <div
      className={`
        cursor-pointer
    ...
    >
      ...
      />
      <div className="p-4">
        <h3 className="text-md font-semibold text-white max-lg:text-sm max-md:text-lg">{histoireWithImage.titre}</h3>
        {showContent && (
